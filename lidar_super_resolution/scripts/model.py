...
pcd_eval_path = os.path.join(root_dir, 'pcd', case_name)
# checkpoint_name = "cp-{epoch:04d}.ckpt"
checkpoint_name = f"cp-{case_name}.ckpt"
checkpoint_path = os.path.join(weight_path, checkpoint_name)
...
print('Weight name:              {}'.format(checkpoint_path))
path_lists = [log_path, weight_path, pcd_eval_path]
