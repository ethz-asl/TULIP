...
def build_multimae_pretraining_dataset(args, is_train = True):
    ...
    if is_train:
        ...
        return MultiTaskImageFolder(os.path.join(args.data_path, "val"), args.all_domains, transform=transform)
