...
args=(
    ...
    # --save_pcd
    # WandB Parameters
    --run_name KITTI2000000_64_1024:baseline_nopretrain
    --entity biyang
    # --wandb_disabled
    --project_name experiment_kitti
    --output_dir /cluster/work/riner/users/biyang/experiment/kitti/Upsampling/Baseline_nopretrain_kitti2000000
